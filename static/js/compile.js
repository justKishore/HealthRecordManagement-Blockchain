...
function compilingPreperations() {
    const buildPath = path.resolve('/home/heisenberg/Desktop/Project-sql retry1/record-management/build/contracts');
...
function createConfiguration() {
    return {
        ...
        sources: {
            'record.sol': {
                content: fs.readFileSync(path.resolve('/home/heisenberg/Desktop/Project-sql retry1/record-management/build/contracts/record.sol'), 'utf8')
            },
            'patient.sol': {
                content: fs.readFileSync(path.resolve('/home/heisenberg/Desktop/Project-sql retry1/record-management/build/contracts/patient.sol'), 'utf8')
            }
        },
        settings: {
